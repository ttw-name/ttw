...
int32_t FunctionServlet::handle(ttw::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("ttw/1.0"));
}

int32_t ServletDispatch::handle(ttw::http::HttpRequest::ptr request
               , ttw::http::HttpResponse::ptr response
               , ttw::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(ttw::http::HttpRequest::ptr request
                   , ttw::http::HttpResponse::ptr response
                   , ttw::http::HttpSession::ptr session) {
    response->setStatus(ttw::http::HttpStatus::NOT_FOUND);
    response->addHeaderKey("Server", "ttw/1.0.0");
    response->addHeaderKey("Content-Type", "text/html");
